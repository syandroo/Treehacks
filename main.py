...
def main():
    ...
    print ['hello, there', 'this is a strawberry', 'have fun', 'i hate you']
    print text_analysis.sentimentize(['hello, there', 'this is a strawberry', 'have fun', 'i hate you'])
    tester = text_analysis.removeNonAscii(text_analysis.articleSummary(inputTitle, inputText))
    print tester
